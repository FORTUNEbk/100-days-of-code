...
public class Main {
  ...
  public static void main(String[] args) {
    Student student1 = new Student(1, "Ibrahim Nyakundi", "nyakundi01.gmail.com", 25);
    ...
    Instructor instructor1 = new Instructor(2, "Jeniffer murithi", "jennym0234@school.com", 75000.00);
